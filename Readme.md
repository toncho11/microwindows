Home of NXDSKTOP - a x86 graphical desktop environment with companion applications running on [Nano X](https://github.com/ghaerr/microwindows) and [ELKS](https://github.com/ghaerr/elks) operating system. NXDSKTOP can run on the oldest x86 machine - the IBM 5150/5160, but at least an 8 MHz machine such as the Amstrad 1640 is recommended. A 286, 386 or 486 will be even better. A VGA video card is required.
...
* nxdsktop - provides a graphical desktop environment with app launcher and UI dialogs. You can both view an image and view/edit a file by only using the mouse. It provides quick access to some system commands. Nxdsktop is auto-updating the amount of available free/total memory in the lower right corner. This allows you to start several nx applications, but you are always aware how far you can go before you run out of memory. Nxdsktop uses nxselect and nxmsg to provide visual dialogs to the user.
